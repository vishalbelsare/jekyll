...
{% include figure.html filename="es-tr-intro-a-datos-enlazados-01.png" caption="Manera clásica de representar una tripleta" %}

Así que nuestra tripleta de Jack Straw, en una forma más legible para los humanos, podría representarse así:

{% include figure.html filename="es-tr-intro-a-datos-enlazados-02.png" caption="Diagrama triple que muestra que Jack Straw representó a Blackburn" %}
...
{% include figure.html filename="en-or-intro-to-linked-data-03.png" caption="cuadro de consulta predeterminado de snorql, con algunos prefijos declarados para ti" %}
...
{% include figure.html filename="en-or-intro-to-linked-data-04.png" caption="Parte inicial de la lista de resultados de una consulta para todas las tripletas con 'Lyndal_Roper' como sujeto" %}
...
{% include figure.html filename="en-or-intro-to-linked-data-05.png" caption="historiadores, según DBpedia" %}
...
{% include figure.html filename="en-or-intro-to-linked-data-06.png" caption="Historiadoras británicas, según DBpedia" %}
