...
You can download this sample `.md` file [from the _Programming Historian_ repository](/assets/sustainable-authorship-in-plain-text-using-pandoc-and-markdown/sample.md).
