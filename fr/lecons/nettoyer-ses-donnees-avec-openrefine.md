...
{% include figure.html filename="en-or-cleaning-data-with-openrefine-01.png" caption="Figure 1: Capture d'écran d'un objet échantillon en provenance du site web du Powerhouse Museum" %}
